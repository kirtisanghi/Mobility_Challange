...
mutually_exclusive_group.add_argument("--s3-input-path-prefix", help="Prefix of the video file stored in ieee s3 bucket")

parser.add_argument("--output-file-name", default=None, help="csv file name for output of object detection")
...
def main():
    ...
    if args.input_path is not None:
        ...
        detect_and_track_with_local_file(input_path, output_file_name)
    else:
        ...
        for object_key in video_object_keys:
            ...
            detect_and_track_with_s3_file(object_key, signed_url, output_file_name)
